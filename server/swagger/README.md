...
⚠️ **Warning:** The API is currently considered Beta and major changes are planned. Follow updates via [https://github.com/SomethingGeneric/bingusboard](https://github.com/SomethingGeneric/bingusboard).
...
If you are planning on using the Boards API, we would love to hear about what you'd like to do, and how we can improve the APIs in the future. Share your plans or feedback in [https://github.com/SomethingGeneric/bingusboard/discussions](https://github.com/SomethingGeneric/bingusboard/discussions).
