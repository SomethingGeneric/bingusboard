...
To discuss opening a `Help Wanted` ticket with the core team, start a thread at [https://github.com/SomethingGeneric/bingusboard/discussions](https://github.com/SomethingGeneric/bingusboard/discussions).
